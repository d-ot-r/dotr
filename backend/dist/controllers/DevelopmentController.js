...
exports.delete_Development_WhyDOTR_By_ID = exports.update_Development_WhyDOTR_By_ID = exports.add_Development_WhyDOTR = exports.get_Development_WhyDOTR_By_Category = exports.delete_Development_Services_By_ID = exports.update_Development_Services_By_ID = exports.add_Development_Services = exports.get_Development_Services_By_Group = exports.get_All_Development_Services = exports.get_Development_Projects_By_Category = exports.get_All_Development_Projects = exports.delete_Development_Offerings_By_ID = exports.update_Development_Offerings_By_ID = exports.add_Development_Offerings = exports.get_Development_Offerings_By_Category = exports.delete_Development_Importance_By_ID = exports.update_Development_Importance_By_ID = exports.add_Development_Importance = exports.get_Development_Importance_By_Category = exports.delete_Development_HERO_By_ID = exports.update_Development_HERO_By_ID = exports.add_Development_HERO = exports.get_Development_Hero_By_Category = exports.delete_Development_FAQs_By_ID = exports.update_Development_FAQs_By_ID = exports.add_Development_FAQs = exports.get_Development_FAQs_By_Category = void 0;
...
const update_Development_FAQs_By_ID = async (req, res, next) => {
    try {
        ...
        const result = await FAQs_Of_Services_Model_1.FAQs_Of_Development_Model.findOneAndUpdate({ category, "faqs._id": faqId }, {
            $set: {
                "faqs.$.id": id,
                "faqs.$.title": title,
        ...
        const updatedfaq = result.faqs.find((faq) => faq._id.toString() === faqId);
...
const delete_Development_FAQs_By_ID = async (req, res, next) => {
    try {
        ...
        const updatedDoc = await FAQs_Of_Services_Model_1.FAQs_Of_Development_Model.findOneAndUpdate({ category }, { $pull: { faqs: { _id: faqId } } }, { new: true });
        if (!updatedDoc) {
...
const add_Development_HERO = async (req, res, next) => {
    try {
        ...
        const existingHero = await HERO_Of_Services_Model_1.HERO_Of_Development.findOne({ category });
        if (existingHero) {
            return res
                .status(409)
        ...
        const newHero = new HERO_Of_Services_Model_1.HERO_Of_Development({
            category,
            title,
            tagline,
            description,
...
const update_Development_HERO_By_ID = async (req, res, next) => {
    try {
        ...
        const updatedHero = await HERO_Of_Services_Model_1.HERO_Of_Development.findByIdAndUpdate(heroId, updates, { new: true });
        if (!updatedHero) {
...
const delete_Development_HERO_By_ID = async (req, res, next) => {
    try {
        ...
        const deleteHero = await HERO_Of_Services_Model_1.HERO_Of_Development.findByIdAndDelete(heroId);
        if (!deleteHero) {
...
const get_Development_Importance_By_Category = async (req, res) => {
    try {
        const { category } = req.params;
        const importance = await IMPORTANCE_Of_Services_Model_1.IMPORTANCE_Of_Development_Model.find({
            category: category,
        });
...
const add_Development_Importance = async (req, res, next) => {
    try {
        ...
        const existingImportance = await IMPORTANCE_Of_Services_Model_1.IMPORTANCE_Of_Development_Model.findOne({
            category,
        });
...
const update_Development_Importance_By_ID = async (req, res, next) => {
    try {
        ...
        const updatedImportance = await IMPORTANCE_Of_Services_Model_1.IMPORTANCE_Of_Development_Model.findByIdAndUpdate(importanceId, updates, { new: true });
...
const delete_Development_Importance_By_ID = async (req, res, next) => {
    try {
        ...
        const importanceDoc = await IMPORTANCE_Of_Services_Model_1.IMPORTANCE_Of_Development_Model.findById(importanceId);
        if (!importanceDoc || importanceDoc.category !== category) {
            return res
                .status(404)
                .json({ message: "Importance not found for this category." });
        }
        const deleteImportance = await IMPORTANCE_Of_Services_Model_1.IMPORTANCE_Of_Development_Model.findByIdAndDelete(importanceId);
        if (!deleteImportance) {
            return res
                .status(404)
...
const get_Development_Offerings_By_Category = async (req, res) => {
    try {
        const { category } = req.params;
        const offerings = await OFFERINGs_Of_Services_Model_1.OFFERINGs_Of_Development_Model.find({
            category: category,
        });
...
const update_Development_Offerings_By_ID = async (req, res, next) => {
    try {
        ...
        const result = await OFFERINGs_Of_Services_Model_1.OFFERINGs_Of_Development_Model.findOneAndUpdate({ category, "offerings._id": offeringId }, {
            $set: {
                "offerings.$.id": id,
...
const delete_Development_Offerings_By_ID = async (req, res, next) => {
    try {
        ...
        const updatedDoc = await OFFERINGs_Of_Services_Model_1.OFFERINGs_Of_Development_Model.findOneAndUpdate({ category }, { $pull: { offerings: { _id: offeringId } } }, { new: true });
        if (!updatedDoc) {
            return res
                .status(404)
...
exports.get_All_Development_Projects = get_All_Development_Projects;
const get_Development_Projects_By_Category = async (req, res) => {
    try {
        const { group } = req.params;
        const { category } = req.params;
        const development_projects = await PROJECTs_Of_Services_Model_1.PROJECTs_Of_Development.find({
...
exports.get_All_Development_Services = get_All_Development_Services;
const get_Development_Services_By_Group = async (req, res) => {
    try {
        const { group } = req.params;
        const services = await SERVICEs_Of_Departments_1.Development_Services_Model.findOne({
            group: group,
        });
...
const add_Development_Services = async (req, res, next) => {
    try {
        ...
        const groupDoc = await SERVICEs_Of_Departments_1.Development_Services_Model.findOne({
            group,
        });
        if (groupDoc) {
            // Filter out duplicates
...
const update_Development_Services_By_ID = async (req, res, next) => {
    try {
        ...
        const result = await SERVICEs_Of_Departments_1.Development_Services_Model.findOneAndUpdate({ group, "services._id": serviceId }, {
            $set: {
                "services.$.id": id,
        ...
        const updatedService = result.services.find((service) => service._id.toString() === serviceId);
...
const delete_Development_Services_By_ID = async (req, res, next) => {
    try {
        ...
        const deleteService = await SERVICEs_Of_Departments_1.Development_Services_Model.findOneAndUpdate({ group }, { $pull: { services: { _id: serviceId } } }, { new: true });
        if (!deleteService) {
            return res
                .status(404)
...
const update_Development_WhyDOTR_By_ID = async (req, res, next) => {
    try {
        ...
        const updatedDoc = await Why_DOTR_For_Services_Model_1.Why_DOTR_For_Development.findOneAndUpdate({
            category,
...
const delete_Development_WhyDOTR_By_ID = async (req, res, next) => {
    try {
        ...
        const updatedDoc = await Why_DOTR_For_Services_Model_1.Why_DOTR_For_Development.findOneAndUpdate({ category }, { $pull: { reasons: { _id: whyDOTRId } } }, { new: true });
        if (!updatedDoc) {
            return res
                .status(404)
