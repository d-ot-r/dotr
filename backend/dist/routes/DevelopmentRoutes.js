...
router.post("/faqs/add", async (req, res) => {
    try {
        await (0, DevelopmentController_1.add_Development_FAQs)(req, res);
    }
    catch (error) { }
});
router.put("/faqs/:category/update/:faqId", async (req, res) => {
    try {
        await (0, DevelopmentController_1.update_Development_FAQs_By_ID)(req, res);
    }
    catch (error) { }
});
router.delete("/faqs/:category/delete/:faqId", async (req, res) => {
    try {
        await (0, DevelopmentController_1.delete_Development_FAQs_By_ID)(req, res);
    }
    catch (error) { }
});
...
router.post("/hero/:category/add", async (req, res) => {
    try {
        await (0, DevelopmentController_1.add_Development_HERO)(req, res);
    }
    catch (error) { }
});
router.put("/hero/:category/update/:heroId", async (req, res) => {
    try {
        await (0, DevelopmentController_1.update_Development_HERO_By_ID)(req, res);
    }
    catch (error) { }
});
router.delete("/hero/:category/delete/:heroId", async (req, res) => {
    try {
        await (0, DevelopmentController_1.delete_Development_HERO_By_ID)(req, res);
    }
    catch (error) { }
});
...
router.post("/offerings/add", async (req, res) => {
    try {
        await (0, DevelopmentController_1.add_Development_Offerings)(req, res);
    }
    catch (error) { }
});
router.put("/offerings/:category/update/:offeringId", async (req, res) => {
    try {
        await (0, DevelopmentController_1.update_Development_Offerings_By_ID)(req, res);
    }
    catch (error) { }
});
router.delete("/offerings/:category/delete/:offeringId", async (req, res) => {
    try {
        await (0, DevelopmentController_1.delete_Development_Offerings_By_ID)(req, res);
    }
    catch (error) { }
});
...
router.post("/importance/:category/add", async (req, res) => {
    try {
        await (0, DevelopmentController_1.add_Development_Importance)(req, res);
    }
    catch (error) { }
});
router.put("/importance/:category/update/:importanceId", async (req, res) => {
    try {
        await (0, DevelopmentController_1.update_Development_Importance_By_ID)(req, res);
    }
    catch (error) { }
});
router.delete("/importance/:category/delete/:importanceId", async (req, res) => {
    try {
        await (0, DevelopmentController_1.delete_Development_Importance_By_ID)(req, res);
    }
    catch (error) { }
});
...
router.post("/services/add", async (req, res) => {
    try {
        await (0, DevelopmentController_1.add_Development_Services)(req, res);
    }
    catch (error) { }
});
router.put("/services/:group/update/:serviceId", async (req, res) => {
    try {
        await (0, DevelopmentController_1.update_Development_Services_By_ID)(req, res);
    }
    catch (error) { }
});
router.delete("/services/:group/delete/:serviceId", async (req, res) => {
    try {
        await (0, DevelopmentController_1.delete_Development_Services_By_ID)(req, res);
    }
    catch (error) { }
});
...
router.post("/why-dotr/add", async (req, res) => {
    try {
        await (0, DevelopmentController_1.add_Development_WhyDOTR)(req, res);
    }
    catch (error) { }
});
router.put("/why-dotr/:category/update/:whyDOTRId", async (req, res) => {
    try {
        await (0, DevelopmentController_1.update_Development_WhyDOTR_By_ID)(req, res);
    }
    catch (error) { }
});
router.delete("/why-dotr/:category/delete/:whyDOTRId", async (req, res) => {
    try {
        await (0, DevelopmentController_1.delete_Development_WhyDOTR_By_ID)(req, res);
    }
    catch (error) { }
});
